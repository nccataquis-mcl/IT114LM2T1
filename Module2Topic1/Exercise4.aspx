...
<body>
    ...
    <form runat="server">
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=RequiredFieldValidator%20Control --%>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1"  ControlToValidate="fullName" runat="server"/>
        ...
        <asp:RangeValidator ID="Age_Validator" runat="server" ControlToValidate="age" 
        ErrorMessage="Enter value between(1-100)" MaximumValue="100" 
        ...
        <asp:RegularExpressionValidator ID="Email_Validator" runat="server" ControlToValidate="email"
        ...
        <asp:CompareValidator ID="ConfirmEmail_Validator" runat="server" ControlToValidate="confirmEmail"
